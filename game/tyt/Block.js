...
Block.prototype.merge = function (totalGeometry, geometry, index, positions) {
...
Block.prototype.mapUv = function (textureWidth, textureHeight, geometry, faceIdx, x1, y1, x2, y2, flag) {
...
Block.prototype.openDoor = function () {
    MAnimation.customAnimation.to(this.door.position, 1, { z: -4.5 });
    MAnimation.customAnimation.to(this.secondDoor.position, 1, { z: -0.5 });
}
Block.prototype.closeDoor = function () {
    MAnimation.customAnimation.to(this.door.position, 1, { z: -3.3 });
    MAnimation.customAnimation.to(this.secondDoor.position, 1, { z: -1.7 });
}
Block.prototype.rotateBox = function () {
    MAnimation.customAnimation.to(this.middle.rotation, 0.5, { y: -Math.PI / 2 });
}
Block.prototype.playMusic = function () {
    var _this2 = this;
    ...
    for (var i = 0; i < 2; ++i) {
        setTimeout(function (icon) {
            return function () {
                ...
                MAnimation.customAnimation.to(icon.position, 2, { x: 5 * (1 - 2 * Math.random()), y: 15, z: 5 * (1 - 2 * Math.random()) });
                ...
                MAnimation.customAnimation.to(icon.material, 2, { opacity: 0 });
            };
        }(this.icons[i]), i * 1000);
    }
...
Block.prototype.stopMusic = function () {
    if (this.musicTimer) {
...
Block.prototype.change = function (radius, t, radiusScale) {
    if (!this.canChange) return;
    if (this.order >= 9) {
        var min = this.order >= 13 ? 0.7 : 0.6;
        this.radiusScale = radiusScale || Math.max((0, random)() * (Config.BLOCK.maxRadiusScale - Config.BLOCK.minRadiusScale) + Config.BLOCK.minRadiusScale, this.min || min);
    ...
    this.radiusScale = radiusScale || (0, random)() * (Config.BLOCK.maxRadiusScale - Config.BLOCK.minRadiusScale) + Config.BLOCK.minRadiusScale;
    this.radiusScale = +this.radiusScale.toFixed(2);
    this.radius = radius || this.radiusScale * Config.BLOCK.radius;
    this.radius = +this.radius.toFixed(2);
    this.obj.scale.set(this.radiusScale, 1, this.radiusScale);
...
Block.prototype.changeColor = function (t) {
...
Block.prototype._shrink = function () {
...
Block.prototype.showup = function (i) {
    ...
    (0, MAnimation.TweenAnimation)(this.body.position.y, Config.BLOCK.height / 2 - this.height / 2, 500, 'Bounce.easeOut', function (value, complete) {
        this.body.position.y = value;
    }.bind(this));
    (0, MAnimation.TweenAnimation)(this.shadow.position.z, shadowZ, 500, 'Bounce.easeOut', function (value, complete) {
...
Block.prototype.popup = function () {
    if (this.order == 15) {
        this.hideGlow();
    ...
    // 	this.shadow.position.z = value
    // }.bind(this))
    MAnimation.customAnimation.to(this.body.position, 0.5, { y: Config.BLOCK.height / 2 - this.height / 2, ease: 'Bounce.easeOut' });
    MAnimation.customAnimation.to(this.shadow.position, 0.5, { z: shadowZ, ease: 'Bounce.easeOut' });
}
...
Block.prototype.rebound = function () {
    this.status = 'stop';
    this.scale = 1;
    MAnimation.customAnimation.to(this.body.scale, 0.5, { ease: 'Elastic.easeOut', y: 1 });
    MAnimation.customAnimation.to(this.body.position, 0.5, { ease: 'Elastic.easeOut', y: Config.BLOCK.height / 2 - this.height / 2 });

    MAnimation.customAnimation.to(this.shadow.scale, 0.5, { ease: 'Elastic.easeOut', y: this.shadow.initScale });
    MAnimation.customAnimation.to(this.shadow.position, 0.5, { ease: 'Elastic.easeOut', z: this.shadow.initZ });
}
