var _random = require('./MRandom');
var _animation = require('./TweenAnimation');
var Storage = require('./Storage');
var GameCtrl = require('./GameCtrl');
var GameView = require('./GameView');
var GameModel = require('./GameModel');
var InstuctionCtrl = require('./InstuctionCtrl');
var HistoryTimes = require('./HistoryTimes');
...
var TailSystem = require('./TailSystem');
var viewer = require('./viewer');
var RankSystem = require('./RankSystem');
var Rank = require('./Rank');
var NetWork = require('./Network');
var PointInPolygon = require('./PointInPolygon');
...
Game.prototype.update = function (tickTime) {
    var _this = this;
...
Game.prototype.handleWxOnHideEvent = function () {
    this.show = false;
...
Game.prototype.addWave = function () {
    var that = this;
...
Game.prototype.checkHit2 = function () {
...
Game.prototype.resetScene = function () {
    this.firstAnimating = false;
...
Game.prototype.generateHardDistances = function () {
    ...
    for (var i = 0; i < amount; ++i) {
        if (i < amount - 1) {
            distances.push(Config.BLOCK.minDistance + (0, _random.random)() * 2);
        } else {
            distances.push(Config.BLOCK.maxDistance - (0, _random.random)() * 2);
        }
    }
    return distances;
}
    ...
    var touchEnd = function touchEnd(e) {
        ...
        if (that.stage == 'game') {
            if (that.bottle.status === 'prepare' && !that.pendingReset && !(that.guider && that.animating)) {
                ...
                that.distance = Config.BLOCK.minDistance + (0, _random.random)() * (Config.BLOCK.maxDistance - Config.BLOCK.minDistance);
