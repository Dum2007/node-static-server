...
Lookers.prototype.showLookers = function (opt) {
    this.showState = true;
    opt = opt || {};
    this._drawLookers(opt);
}
Lookers.prototype.showLookersShare = function (opt) {
    this.showState = true;
    opt = opt || {};
}
Lookers.prototype.hideLookers = function () {
...
// ----------------- 背景绘制 -----------------
Lookers.prototype._drawLookers = function (opt) {
    var _this = this;
...
// ----------------- 画布创建与更新 -----------------
Lookers.prototype._createPlane = function () {
// 创建画布
    for (var i = 0; i < planList.length; i++) {
...
Lookers.prototype._updatePlane = function (type) {
// 画布更新
    if (!this.showState) {
        return;
    }
...
// ----------------- 工具函数 -----------------
Lookers.prototype._drawImageCenter = function (src, x, y, width, height, type, cb) {
...
Lookers.prototype._cx = function (x) {
    var realx = x * W / 414;
    return realx * Dpr;
}
Lookers.prototype._cf = function (size) {
    // font size
