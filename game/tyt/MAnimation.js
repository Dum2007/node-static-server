...
// var _tween2 = require('./Tween')

var MAnimation = {};
MAnimation.TweenAnimation = function(from, to, duration, easing, callback) {
...
MAnimation.killAll = function () {
    killAnimationId = animationId;
};

MAnimation.customAnimation = {};

MAnimation.customAnimation.to = function (obj, duration, options) {
    duration *= 1000;
        ...
        if (name === 'delay') {
            ...
            setTimeout(function (name) {
                return function () {
                    ...
                    MAnimation.TweenAnimation(obj[name], options[name], duration, options.ease || 'Linear', function (value, complete) {
                        obj[name] = value;
                        if (complete) {
