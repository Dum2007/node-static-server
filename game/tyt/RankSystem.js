...
RankSystem.prototype.update = function () {
    // 没有好友数据就不更新了
...
RankSystem.prototype.checkScore = function () {
...
RankSystem.prototype.animateAvator = function () {
    var _this = this;
...
RankSystem.prototype.playAnimate = function () {
    var _this2 = this;
    ...
    MAnimation.customAnimation.to(this.obj.position, 0.4, {
        y: AnimateHeight + AvatorY
    });
    MAnimation.customAnimation.to(this.text.material, 0.4, {
        opacity: 1
    });
    MAnimation.customAnimation.to(this.avatorOuter.material, 0.4, {
        opacity: 1
    });
    MAnimation.customAnimation.to(this.avatorFrame.material, 0.4, {
        opacity: 1
    });
...
RankSystem.prototype.resetAvator = function () {
    this.obj.visible = false;
    this.text.obj.visible = false;
...
RankSystem.prototype.reset = function () {
    this.seed = 0;
    this.seed = 0;
    this.startDist = 0;
    this.startDist = 0;
