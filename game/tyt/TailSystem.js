...
var TailSystem = function (scene, bottle) {
    this.scene = scene;
    this.bottle = bottle;
...
TailSystem.prototype.init = function () {
...
TailSystem.prototype.update = function (tickTime) {
...
TailSystem.prototype.updateActiveCell = function (tickTime) {
...
TailSystem.prototype.correctPosition = function () {
    this.lastDotPosition = this.bottle.obj.position.clone();
}
TailSystem.prototype.layEgg = function (lastDotPosition, nowPosition) {
...
TailSystem.prototype.getMesh = function () {
...
TailSystem.prototype.allReset = function () {
    this.tailsRemainPool.forEach(function (el) {
        el.reset();
    });
}

var CellTail = function (geometry, material) {
    this.tickTime = 0;
...
CellTail.prototype.reset = function () {
    this.tickTime = 0;
